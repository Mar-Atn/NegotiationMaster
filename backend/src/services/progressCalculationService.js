...
class ProgressCalculationService {
  ...
  async createInitialProgress(userId) {
    const initialProgress = {
      ...
      successful_deals: 0,
      avg_claiming_value_score: 0,
      avg_creating_value_score: 0,
      avg_managing_relationships_score: 0,
      avg_overall_score: 0,
      best_claiming_value_score: 0,
      best_creating_value_score: 0,
      best_managing_relationships_score: 0,
